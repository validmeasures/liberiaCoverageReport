...
```{r icf1plot, echo = FALSE, eval = TRUE, fig.cap = "IYCF counselling coverage in Greater Monrovia", fig.height = 6, fig.width = 8, fig.align = "center", fig.pos = "H"}
...
```{r icf1map, echo = FALSE, eval = TRUE, fig.cap = "Spatial distribution of IYCF counselling coverage in Greater Monrovia", fig.width = 8, fig.height = 8, fig.align = "center", fig.pos = "H"}
...
```{r icf2map, echo = FALSE, eval = TRUE, fig.cap = "Spatial distribution of IYCF counselling coverage in Grand Bassa", fig.width = 8, fig.height = 8, fig.align = "center", fig.pos = "H"}
...
```{r vit1plot, echo = FALSE, eval = TRUE, fig.cap = "Vitamin A supplementation coverage in Greater Monrovia", fig.height = 6, fig.width = 4, fig.align = "center", fig.pos = "H"}
...
```{r screen1map, echo = FALSE, eval = TRUE, fig.cap = "Spatial distribution of acute undernutrition screening coverage in Greater Monrovia", fig.width = 8, fig.height = 8, fig.align = "center", fig.pos = "H"}
...
```{r screen2map, echo = FALSE, eval = TRUE, fig.cap = "Spatial distribution of acute undernutrition screening coverage in Grand Bassa", fig.width = 8, fig.height = 8, fig.align = "center", fig.pos = "H"}
...
```{r cmam1plot, echo = FALSE, eval = TRUE, fig.cap = "CMAM coverage", fig.height = 8, fig.width = 8, fig.align = "center", fig.pos = "H", fig.retina = 1}
...
```{r cmamMap1, echo = FALSE, eval = TRUE, fig.cap = "Spatial distribution of CMAM coverage in Greater Monrovia", fig.width = 10, fig.height = 8, fig.align = "center", fig.pos = "H"}
x <- cmamBaseGM
...
```{r cmamMap2, echo = FALSE, eval = TRUE, fig.cap = "Spatial distribution of CMAM coverage in Grand Bassa", fig.width = 10, fig.height = 8, fig.align = "center", fig.pos = "H"}
x <- cmamBaseGB
names(x) <- c("county", "cf", "tc")
x@data <- data.frame(id = row.names(x), round = "Baseline", x@data)
xGeom <- fortify(x)
